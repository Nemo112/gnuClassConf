    ...
    class App:
        ...
        def getNewDir(self):
            ...
            dirname = tkFileDialog.askdirectory(
                parent=self.root,
                initialdir=home,
                title='Vyberte složku pro sdílení')
            if dirname == "/":
                return
            elif "/" in dirname:
        ...
        def paintLayout(self):
            ...
            Button(
                ...
                height=1,
                width=24,
                text="Přidat složku k sdílení",
                command=self.getNewDir).place(
                relx=0.028,
                rely=0.01)
            # sdílené složky
            ...
            Label(
                ...
                height=1,
                width=24,
                text="Klepnutím složku odeberete").pack()
            ...
            Label(
                ...
                height=3,
                width=24,
                text="Zeleně jsou označeny složky\npro čtení a zápis,\noranžově složky pro čtení.").place(
                relx=0.076,
                rely=0.85)
