...
class ParConfFl:
    ...
    def getTftp(self):
        ...
        """
        if os.path.isfile("./configuration/tftpath") is False:
            return None
        ret = ""
    ...
    def getInterfaces(self):
        ...
        """
        if os.path.isfile("./configuration/interfaces") is False:
            return None
        ret = dict()
...
if __name__ == "__main__":
    ...
    parser.add_option(
        ...
        dest="inn",
        default=False,
        help="Showing which interface is for class and which for outer connections")
    parser.add_option(
        "-i",
        "--inner-interface",
        action="store",
    ...
    parser.add_option(
        ...
        dest="outer",
        default="",
        help="Settting up for interface outside of class")
    parser.add_option(
        "-t",
        "--tft-path",
        action="store_true",
        default=False,
        dest="tftp",
        help="Getting TFTP path for DHCP which is going to be used")
