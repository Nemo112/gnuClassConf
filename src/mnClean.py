    ...
    class App:
        ...
        def erase(self):
            ...
            result = tkMessageBox.askquestion(
                "Smazání",
                "Doopravdy smazat celý obraz učebny?",
                icon='warning')
            if result == "yes":
                self.qi.put("ERASE")
        ...
        def paintLayout(self):
            ...
            Button(
                ...
                height=1,
                width=21,
                text="Vyčistit balíčky obrazu",
                command=self.clear).pack()
            Button(
                gpMan,
                height=1,
                width=21,
                text="Aktualizovat třídu",
                command=self.update).pack()
            # Velikost zaplnění os
            Label(
                self.root,
                text="Zaplnění souborového systému:").place(
                relx=0.02,
                rely=0.5)
            ...
            Button(
                ...
                height=1,
                width=21,
                text="Smazat obraz učebny",
                command=self.erase).pack()
            # Výpisky
