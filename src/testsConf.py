...
if __name__ == "__main__":
    class App:
        ...
        def __init__(self, r):
            ...
            """
            # Ukazatel na instanci objektu obsahujícím třídu, která konotroluje
            # obsah konfiguračních souborů
            self.cf = ConfCheck()
            # Proměnná funguje jako vlaječka pro kontrolu všech konfiguračních
            # souborů, pokud dojde k chybě, zůstane na 0
            self.flg = 0
            # Ukazatel na okno
            self.root = r
        ...
        def printFotNote(self):
            ...
            if self.flg == 0:
                ...
                tx = StringVar()
                tx.set(
                    "Některé služby nejsou nastaveny, \n pokuste se je znovu \n nainstalovat")
                en = Label(self.root, textvariable=tx, font="Verdana 10")
