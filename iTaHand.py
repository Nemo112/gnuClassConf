...
class iTaHand:
	...
	def setUpIcaS(self):
		...
		self.sy.copyLargeFile("./data/stIca.sh","/NFSROOT/class/addons/stIca.sh")
		os.chmod("/NFSROOT/class/addons/stIca.sh",0755)
		self.sy.removeFl("/NFSROOT/class/home/student/.config/autostart/icastart.desktop")
		tar = open ("/NFSROOT/class/home/student/.config/autostart/icastart.desktop", 'a')
	...
	def setCliSc(self):
		...
		tar.write("true\n")
		tar.close()
		os.chmod("/NFSROOT/class/etc/rcS.d/S20-ica-launcher",0757)
	def staWin(self):
	...
	def tstItalc(self):
		...
		"""
		if os.path.isfile("/usr/bin/italc") and os.path.isfile("/NFSROOT/class/usr/bin/ica"):
			return True
		else:
			return False
